...
const HistoryCardSettled = ({ loading, settled }) => {
      ...
      >
        ...
        <div className="main-color">
          ...
          <div
            ...
            style={{ height: "30px" }}
          >
            <p className="bg-transparent text-card">Anti</p>
            <p className="bg-transparent text-card">{item.market.pick}</p>
            <p className="bg-transparent text-card fw-bold anti-percent">
              {item.market.odd}%
            </p>
          </div>
...
export default HistoryCardSettled;
